...
class Membres implements PasswordAuthenticatedUserInterface
{
  ...
  public function toarr()
  {
        return [
            "id"=> $this->id,
            "category_id"=>$this->category_id->getId(),
            "type"=>$this->type,
            "civilite"=>$this->civilite,
            "nom"=>$this->nom,
            "prenom"=>$this->prenom,
            "autre_fonction"=>$this->autre_fonction,
            "fonction_id"=>$this->fonction_id != null ? $this->fonction_id->getId() :  null,
            "tel"=>$this->tel,
            "fax"=>$this->fax,
            "password"=>$this->password,
            "email"=>$this->email,
            "siren_entreprise"=>$this->siren_entreprise,
            "siret_entreprise"=>$this->siret_entreprise,
            "raison_social"=>$this->raison_social,
            "effectifs_entreprise"=>$this->effectifs_entreprise,
            ...
            "tel_secondaire"=>$this->tel_secondaire,
            "departement_id"=>$this->departement_id->getId(),
            "complement_adresse"=>$this->complement_adresse,
            "ville_id"=>$this->ville_id->getId(),
            "permis"=>$this->permis,
            "code_postal"=>$this->code_postal,
            "programme_ecole"=>$this->programme_ecole,
            "inscrit_nl"=>$this->inscrit_nl,
