...
$b->push(new \PrestaShop\Module\DistributionApiClient\Middleware\Cache(new \Symfony\Component\Cache\DoctrineProvider(new \Symfony\Component\Cache\Adapter\FilesystemAdapter('', 86400, (\dirname(__DIR__, 4).'/var/cache/prod'.\DIRECTORY_SEPARATOR.'/distribution-api')))));
