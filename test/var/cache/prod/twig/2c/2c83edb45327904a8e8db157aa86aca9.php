...
class __TwigTemplate_ae583239f22535329488ae5ac2605661 extends Template
{
    private $source;
    private $macros = [];
...
$context["action"], "type", [], "any", true, true, false, 68) && (twig_get_attribute($this->env, $this->source, $context["action"], "type", [], "any", false, false, false, 68) == "button"))) {
    ...
    {
        return new Source("", "@PrestaShop/Admin/Helpers/bootstrap_popup.html.twig", "C:\\wamp64\\www\\test\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Helpers\\bootstrap_popup.html.twig");
    }
}
