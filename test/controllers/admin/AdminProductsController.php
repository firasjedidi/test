...
class AdminProductsControllerCore extends AdminController
{
    ...
    {
        // Call the parent method to get the default form
        ...
        $moduleInstance = Module::getInstanceByName('price');

        // Call the module's renderAdminProductExtra method to get the HTML for the custom form field
        $customFieldHtml = $moduleInstance->renderAdminProductExtra(array('id_product' => $productId));

        // Append the custom form field HTML to the default form
        $form .= $customFieldHtml;
